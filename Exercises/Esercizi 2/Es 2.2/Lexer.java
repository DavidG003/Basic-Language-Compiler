            ...
            default:
                ...
                // ... gestire il caso degli identificatori e delle parole chiave //
                    ...
                    while(Character.isLetter(peek) || Character.isDigit(peek) || peek == '_'){
                        s = s + peek;
                        if(only_underscores && peek != '_') only_underscores = false;
                        readch(br);
                    }
                ...
                // ... gestire il caso dei numeri ... //
                    sum = 0;
                    //lo zero può essere solo scritto con '0', i zeri multipli o se viene seguito da un carattere/numero invoca un error
                    if(peek == '0'){
                        readch(br);
